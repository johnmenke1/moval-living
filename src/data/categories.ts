...
export const categories: Category[] = [
  ...
  },
  {
    ...
    name: 'Auto Repair',
    slug: 'auto-repair',
    description: 'Auto repair shops, mechanics, tire shops, smog, oil change, body shops',
    icon: 'Wrench',
  ...
  },
  {
    ...
    name: 'Auto Dealers',
    slug: 'auto-dealers',
    description: 'New and used car dealerships and auto sales',
    icon: 'CarFront',
  ...
  },
  {
    ...
    name: 'Churches',
    slug: 'churches',
    description: 'Churches, chapels, places of worship, and religious congregations',
    icon: 'Church',
  ...
  },
  {
    ...
    description: 'Rental management for apartments, condos, shopping centers, and commercial properties',
    icon: 'Building2',
