...
export function EventsHero({ event, viewLabel }: EventsHeroProps) {
  ...
  return (
    <section className="relative min-h-[70vh] sm:min-h-[75vh] flex items-end overflow-hidden bg-slate-950 text-white">
      {/* Background photo */}
      ...
      {/* Lower content */}
      <div className="relative z-10 w-full">
        <div className="container-max pb-16 sm:pb-24 pt-32 sm:pt-40">
