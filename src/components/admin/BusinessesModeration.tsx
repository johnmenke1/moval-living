...
import { CheckCircle, XCircle, Clock, Trash2, ExternalLink, Building2, Star } from 'lucide-react'
        ...
        <div className="space-y-4">
          {filtered.map(business => {
            ...
            return (
              <div
                key={business.id}
                className={`bg-white rounded-xl border ${cfg.border} p-5`}
              >
                <div className="flex gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-3 mb-1">
                      ...
                      <span
                        className={`inline-flex items-center gap-1 text-xs px-2.5 py-1 rounded-full shrink-0 ${cfg.color}`}
                      >
                  ...
                  {business.status === 'PENDING' && (
                    <div className="flex flex-col gap-2 shrink-0">
                      <button
                        onClick={() => moderate(business.id, 'APPROVED')}
                      ...
                      <button
                        onClick={() => moderate(business.id, 'REJECTED')}
                        disabled={loading === business.id}
