  ...
  if (success) {
    return (
      <div className="text-center py-10 px-4">
        <div className="inline-flex h-16 w-16 items-center justify-center rounded-full bg-[#007a7f]/10 text-[#007a7f] mb-5">
          <CheckCircle className="w-8 h-8" />
        </div>
        <h4 className="text-xl font-bold text-[#1a2e35] mb-2">Message Sent</h4>
      ...
      <div className="container-max">
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-0 rounded-3xl overflow-hidden border border-slate-200 bg-white">
            ...
            <div className="relative p-8 sm:p-10 lg:p-12 bg-gradient-to-br from-[#007a7f]/10 via-white to-[#f0efeb] border-t lg:border-t-0 lg:border-l border-slate-100">
              <div className="absolute top-0 right-0 p-8 opacity-10">
                <Sparkles className="w-32 h-32 text-[#007a7f]" />
              </div>
                ...
                <div className="space-y-4">
                  <a href={BOOKING_URL} target="_blank" rel="noopener noreferrer" className="group flex items-center gap-4 rounded-2xl border border-slate-200 bg-white p-5 hover:border-[#007a7f]/30 hover:shadow-md transition-all">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="font-semibold text-[#1a2e35]">Book a call</div>
                      <div className="text-sm text-[#5a6c72] truncate">{BOOKING_URL.replace('https://', '')}</div>
                    </div>
                  ...
                  <a href={PHONE_HREF} className="group flex items-center gap-4 rounded-2xl border border-slate-200 bg-white p-5 hover:border-[#c9786d]/30 hover:shadow-md transition-all">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="font-semibold text-[#1a2e35]">Call us</div>
                      <div className="text-sm text-[#5a6c72]">{PHONE_NUMBER}</div>
                    </div>
                    <ArrowRight className="w-5 h-5 text-[#5a6c72] group-hover:text-[#c9786d] transition-colors" />
                  </a>
                </div>

                <div className="mt-8 rounded-2xl bg-white border border-slate-200 p-5">
                  <p className="text-sm text-[#5a6c72]">
                    <span className="text-[#1a2e35] font-medium">Typical response time:</span> under 2 hours during business hours. After hours? Leave a message — we check them first thing.
                  </p>
                </div>
              </div>
            </div>
...
function DemoBrowser() {
  ...
  return (
    <div className="relative mx-auto max-w-5xl">
      ...
      {/* Floating stats */}
      <div className="absolute -bottom-8 left-6 right-6 sm:left-auto sm:right-6 sm:-bottom-10 sm:w-80">
        <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-xl">
          <div className="grid grid-cols-2 gap-4">
            <div>
              <div className="text-2xl font-bold text-[#1a2e35]">7–10</div>
              <div className="text-xs text-[#5a6c72] uppercase tracking-wider">days to launch</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-[#1a2e35]">10–20</div>
              <div className="text-xs text-[#5a6c72] uppercase tracking-wider">pages included</div>
            </div>
          </div>
        </div>
      </div>
